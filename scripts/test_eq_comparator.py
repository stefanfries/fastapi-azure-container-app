...
def _replace_greek(
    base: list[tuple[str, str]], overrides: list[tuple[str, str]]
) -> list[tuple[str, str]]:
...
async def main() -> None:
    ...
    async with httpx.AsyncClient(follow_redirects=True, timeout=30) as client:
        ...
        # T1: DELTA eq 0.6
        t1_params = _replace_greek(
            BASE_PARAMS + ALL_DISABLED,
            [
                ("DELTA_VALUE", "0.6"),
                ("DELTA_COMPARATOR", "eq"),
            ],
        ...
        t6_params = _replace_greek(
            BASE_PARAMS + ALL_DISABLED,
            [
                ("IMPLIED_VOLATILITY_VALUE", "50"),
                ("IMPLIED_VOLATILITY_COMPARATOR", "eq"),
            ],
        )
        ...
        t7_params = _replace_greek(
            BASE_PARAMS + ALL_DISABLED,
            [
                ("MONEYNESS_VALUE", "95"),
                ("MONEYNESS_COMPARATOR", "gt"),
                ("MONEYNESS_VALUE", "105"),
                ("MONEYNESS_COMPARATOR", "lt"),
            ],
        )
